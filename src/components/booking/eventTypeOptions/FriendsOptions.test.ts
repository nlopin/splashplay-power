...
describe("calculateFriendsPrice — big canvas", () => {
  ...
  it("3 guests → €90", () => expect(calculateFriendsPrice(1, 3, "big")).toBe(9000));
  it("4 guests → €100", () => expect(calculateFriendsPrice(1, 4, "big")).toBe(10000));
  it("5 guests → €110", () => expect(calculateFriendsPrice(1, 5, "big")).toBe(11000));
  it("6 guests → €120", () => expect(calculateFriendsPrice(1, 6, "big")).toBe(12000));
});
...
describe("calculateFriendsPrice — standard canvas", () => {
  ...
  // 3 guests
  it("3 guests, 1 canvas → €65", () => expect(calculateFriendsPrice(1, 3, "standard")).toBe(6500));
  ...
  // 4 guests
  it("4 guests, 2 canvases → €100", () => expect(calculateFriendsPrice(2, 4, "standard")).toBe(10000));
  ...
  // 6 guests
  it("6 guests, 3 canvases → €140", () => expect(calculateFriendsPrice(3, 6, "standard")).toBe(14000));
  it("6 guests, 4 canvases → €152", () => expect(calculateFriendsPrice(4, 6, "standard")).toBe(15200));
