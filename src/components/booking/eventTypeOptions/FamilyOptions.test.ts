...
describe("calculateFamilyPrice — big canvas", () => {
  it("2 people → €90", () => expect(calculateFamilyPrice(1, 2, "big")).toBe(9000));
  it("3 people → €95", () => expect(calculateFamilyPrice(1, 3, "big")).toBe(9500));
  it("4 people → €105", () => expect(calculateFamilyPrice(1, 4, "big")).toBe(10500));
  it("5 people → €115", () => expect(calculateFamilyPrice(1, 5, "big")).toBe(11500));
  it("6 people → €125", () => expect(calculateFamilyPrice(1, 6, "big")).toBe(12500));
});
...
describe("calculateFamilyPrice — standard canvas, 2 people", () => {
  it("2 people, 1 canvas → €75", () => expect(calculateFamilyPrice(1, 2)).toBe(7500));
...
describe("calculateFamilyPrice — standard canvas, 3 people", () => {
  it("3 people, 1 canvas → €80", () => expect(calculateFamilyPrice(1, 3)).toBe(8000));
...
describe("calculateFamilyPrice — standard canvas, 4 people", () => {
  it("4 people, 2 canvases → €105", () => expect(calculateFamilyPrice(2, 4)).toBe(10500));
...
describe("calculateFamilyPrice — standard canvas, 6 people", () => {
  it("6 people, 3 canvases → €145", () => expect(calculateFamilyPrice(3, 6)).toBe(14500));
  it("6 people, 4 canvases → €155", () => expect(calculateFamilyPrice(4, 6)).toBe(15500));
